    ...
    <div className="space-y-4 sm:space-y-5">
      ...
      <div className="grid gap-3 sm:gap-4 lg:grid-cols-2">
        <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
          ...
          <article className="flex min-h-[150px] flex-col rounded-lg border border-zinc-300/20 bg-black/30 p-4 sm:p-5">
            <h3 className="text-sm font-semibold tracking-wide text-zinc-100 uppercase sm:text-base">GitHub</h3>
            <div className="flex flex-1 items-center justify-center">
              <a
                href={development.repository.url}
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-md border border-zinc-300/25 bg-zinc-900/55 px-4 py-2.5 text-sm font-semibold text-zinc-100 underline decoration-zinc-500 underline-offset-4 sm:text-base"
              >
                <svg
